...
- [Server-side auth and upload pattern](server-auth-upload.md) — client SDK fails on unregistered domains; checkSession uses /api/auth/me, all uploads use /api/upload via uploadViaServer()
