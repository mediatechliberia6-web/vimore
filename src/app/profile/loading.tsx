    ...
    <div className="min-h-screen bg-background animate-pulse">
      ...
      <div className="px-4 -mt-10 space-y-4">
        ...
        <div className="space-y-2">
          <div className="h-5 w-36 rounded-full bg-gray-200 dark:bg-white/10" />
          <div className="h-3.5 w-24 rounded-full bg-gray-200 dark:bg-white/10" />
          <div className="h-3.5 w-56 rounded-full bg-gray-200 dark:bg-white/10 mt-2" />
          <div className="h-3.5 w-44 rounded-full bg-gray-200 dark:bg-white/10" />
        </div>
