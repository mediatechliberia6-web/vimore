export default function EarningsLoading() {
  return (
    <div className="min-h-screen bg-[#F0F2F5] dark:bg-[#060608] animate-pulse">
      ...
      <div className="max-w-2xl mx-auto px-4 pb-32 space-y-5 pt-6">
        {/* Vault Hero */}
        <div className="h-56 rounded-[2rem] bg-gradient-to-br from-gray-200 to-gray-300 dark:from-white/10 dark:to-white/5" />

        {/* Stats */}
        <div className="grid grid-cols-2 gap-3">
          <div className="h-24 rounded-[1.25rem] bg-gray-200 dark:bg-white/10" />
          <div className="h-24 rounded-[1.25rem] bg-gray-200 dark:bg-white/10" />
        </div>
        ...
        <div className="space-y-3">
          {[1, 2, 3].map(i => (
            <div key={i} className="h-16 rounded-2xl bg-gray-200 dark:bg-white/10" />
          ))}
        </div>
      </div>
    </div>
