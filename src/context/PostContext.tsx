...
export function PostProvider({ children }: { children: ReactNode }) {
  ...
  // Real-time Spatial Signaling Listener
  useEffect(() => {
    if (!currentUser.id) return;
