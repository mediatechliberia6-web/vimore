...
export function ChatWindow({ contact, onBack, onJoinLounge }: ChatWindowProps) {
  ...
  return (
    <div className="flex flex-1 h-full bg-[#F0F2F5] dark:bg-[#080808] relative overflow-hidden">
      ...
      <div className="flex flex-col flex-1 h-full relative transition-all duration-500">
      ...
      <aside className={cn(
        "h-full bg-white dark:bg-card border-l border-primary/5 transition-all duration-500 overflow-hidden flex flex-col",
